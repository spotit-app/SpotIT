...
describe('MyJobApplications', () => {
  ...
  test('navigates to company', async () => {
    await waitFor(() => {
      const applicationsButton = screen.getByText('Profil firmy');
...
describe('MyJobApplications without any offers', () => {
  beforeEach(() => {
    nock('http://localhost:80')
      .get(`/api/userAccount/${slugifyAuth0Id('auth0|1234567890')}/application?page=0`)
