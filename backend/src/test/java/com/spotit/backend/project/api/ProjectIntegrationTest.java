package com.spotit.backend.project.api;
...
import static com.spotit.backend.testUtils.ProjectUtils.createProject;
...
public class ProjectIntegrationTest {
    ...
    void shouldReturnErrorWhenErrorCreatingProject() throws Exception {
        // given
        var projectWithTooLongUrl = WriteProjectDto.builder()
    ...
    void shouldReturnModifiedProject() throws Exception {
        ...
        var modifiedProject = createWriteProjectDto(2);
    ...
    void shouldDeleteProject() throws Exception {
        ...
        result.andExpect(status().isOk())
                .andExpect(content().string(getDeletedEntityMessage(projectToDelete.getId())));
    }
