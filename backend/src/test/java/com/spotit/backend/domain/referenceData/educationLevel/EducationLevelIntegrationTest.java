...
import static com.spotit.backend.domain.referenceData.educationLevel.EducationLevelUtils.createEducationLevelWriteDto;
...
class EducationLevelIntegrationTest extends IntegrationTest {
    ...
    void shouldDeleteEducationLevel() throws Exception {
        ...
        var result = mockMvc.perform(
                delete(EDUCATION_LEVEL_API_URL + "/" + educationLevelToDelete.getId()).with(createAdminMockJwt()));
    ...
    void shouldReturnErrorWhenDeletedEducationLevelNotFound() throws Exception {
        ...
        // when
        var result = mockMvc.perform(delete(EDUCATION_LEVEL_API_URL + "/" + educationLevelId).with(
                createAdminMockJwt()));
