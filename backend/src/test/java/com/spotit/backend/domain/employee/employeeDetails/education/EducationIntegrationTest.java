...
import static com.spotit.backend.domain.employee.employeeDetails.education.EducationUtils.createEducation;
...
import com.spotit.backend.domain.referenceData.educationLevel.EducationLevelRepository;
...
class EducationIntegrationTest extends IntegrationTest {
    ...
    void shouldReturnEducationById() throws Exception {
        ...
        educationToCreate.forEach(education -> {
        ...
        // when
        var result = mockMvc
                .perform(get(EDUCATION_API_URL + "/" + wantedEducation.getId()).with(createMockJwt("auth0Id1")));
    ...
    void shouldReturnErrorWhenEducationNotFound() throws Exception {
        ...
        // when
        var result = mockMvc.perform(get(EDUCATION_API_URL + "/" + educationId).with(createMockJwt("auth0Id1")));
    ...
    void shouldDeleteEducation() throws Exception {
        ...
        // when
        var result = mockMvc
                .perform(delete(EDUCATION_API_URL + "/" + educationToDelete.getId()).with(createMockJwt("auth0Id1")));
    ...
    void shouldReturnErrorWhenDeletedEducationNotFound() throws Exception {
        ...
        // when
        var result = mockMvc.perform(delete(EDUCATION_API_URL + "/" + educationId).with(createMockJwt("auth0Id1")));
