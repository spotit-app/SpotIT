...
class SoftSkillNameIntegrationTest extends IntegrationTest {
    ...
    void shouldDeleteSoftSkillName() throws Exception {
        ...
        // when
        var result = mockMvc.perform(delete(SOFT_SKILL_NAME_API_URL + "/" + softSkillNameToDelete.getId()).with(
                createAdminMockJwt()));
    ...
    void shouldReturnErrorWhenDeletedSoftSkillNameNotFound() throws Exception {
        ...
        // when
        var result = mockMvc.perform(delete(SOFT_SKILL_NAME_API_URL + "/" + softSkillNameId).with(
                createAdminMockJwt()));
