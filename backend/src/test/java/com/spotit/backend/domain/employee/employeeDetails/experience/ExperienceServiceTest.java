...
class ExperienceServiceTest {
    ...
    @Test
    void shouldReturnExperienceWhenCreatedSuccessfully() {
        // given
    ...
    void shouldDeleteExperience() {
        ...
        var experienceToDelete = createExperience(experienceToId);

        when(experienceRepository.findById(experienceToId))
                .thenReturn(Optional.of(experienceToDelete));
        ...
        verify(experienceRepository, times(1)).delete(experienceToDelete);
    }
