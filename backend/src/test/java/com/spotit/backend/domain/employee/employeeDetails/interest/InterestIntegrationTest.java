...
class InterestIntegrationTest extends IntegrationTest {
    ...
    void shouldReturnListOfUserInterests() throws Exception {
        ...
        interestsToCreate.forEach(interest -> interest.setUserAccount(userAccount));
    ...
    void shouldReturnInterestById() throws Exception {
        ...
        // when
        var result = mockMvc
                .perform(get(INTEREST_API_URL + "/" + createdInterests.get(1).getId()).with(createMockJwt("auth0Id1")));
    ...
    void shouldDeleteInterest() throws Exception {
        ...
        // when
        var result = mockMvc
                .perform(delete(INTEREST_API_URL + "/" + interestToDelete.getId()).with(createMockJwt("auth0Id1")));
