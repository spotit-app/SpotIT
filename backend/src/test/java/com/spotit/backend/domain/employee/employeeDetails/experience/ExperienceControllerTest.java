...
import static com.spotit.backend.domain.employee.employeeDetails.experience.ExperienceUtils.createExperienceReadDto;
...
class ExperienceControllerTest {
    ...
    void shouldReturnListOfUserExperiences() throws Exception {
        ...
        // when
        var result = mockMvc.perform(get(EXPERIENCE_API_URL).with(createMockJwt(userAuth0Id)));
