...
import static com.spotit.backend.domain.employee.employeeDetails.techSkill.TechSkillUtils.createTechSkill;
...
import com.spotit.backend.domain.referenceData.techSkillName.TechSkillNameRepository;
...
class TechSkillIntegrationTest extends IntegrationTest {
    ...
    void shouldReturnTechSkillById() throws Exception {
        ...
        // when
        var result = mockMvc
                .perform(get(TECH_SKILL_API_URL + "/" + wantedTechSkill.getId()).with(createMockJwt("auth0Id1")));
    ...
    void shouldReturnErrorWhenTechSkillNotFound() throws Exception {
        ...
        // when
        var result = mockMvc.perform(get(TECH_SKILL_API_URL + "/" + techSkillId).with(createMockJwt("auth0Id1")));
    ...
    void shouldDeleteTechSkill() throws Exception {
        ...
        // when
        var result = mockMvc
                .perform(delete(TECH_SKILL_API_URL + "/" + techSkillToDelete.getId()).with(createMockJwt("auth0Id1")));
    ...
    void shouldReturnErrorWhenDeletedTechSkillNotFound() throws Exception {
        ...
        // when
        var result = mockMvc.perform(delete(TECH_SKILL_API_URL + "/" + techSkillId).with(createMockJwt("auth0Id1")));
