...
class ExperienceIntegrationTest extends IntegrationTest {
    ...
    void shouldReturnListOfUserExperiences() throws Exception {
        ...
        experienceToCreate.stream().forEach(social -> social.setUserAccount(userAccount));
    ...
    void shouldReturnExperienceById() throws Exception {
        ...
        // when
        var result = mockMvc.perform(get(EXPERIENCE_API_URL + "/" + wantedExperience.getId()).with(jwt()));
    ...
    void shouldDeleteExperience() throws Exception {
        ...
        // when
        var result = mockMvc.perform(delete(EXPERIENCE_API_URL + "/" + experienceToDelete.getId()).with(jwt()));
