...
import static com.spotit.backend.employee.portfolio.PortfolioUtils.generatePortfolio;
import static com.spotit.backend.employee.portfolio.PortfolioUtils.getInvalidUserMessage;
...
class PortfolioServiceTest {
    ...
    @Test
    void shouldThrowErrorWhenIvalidUserWhileCreating() {
        // given
        var userId = "auth0Id";
        var exampleUser = UserAccount.builder()
                .id(1)
    ...
    @Test
    void shouldThrowErrorWhenIvalidUserWhileUpdating() {
        // given
        var userId = "auth0Id";
        var exampleUser = UserAccount.builder()
                .id(1)
