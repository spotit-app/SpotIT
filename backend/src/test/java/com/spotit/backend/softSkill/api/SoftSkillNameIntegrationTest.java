...
class SoftSkillNameIntegrationTest {
    ...
    void shouldReturnErrorWhenErrorCreatingSoftSkillName() throws Exception {
        // given
        var softSkillNameToCreate = WriteSoftSkillNameDto.builder().build();
    ...
    void shouldReturnModifiedSoftSkillName() throws Exception {
        ...
        var modifiedSoftSkillName = WriteSoftSkillNameDto.builder()
                .name("Name 2")
                .build();
    ...
    void shouldReturnErrorWhenEditedSoftSkillNameNotFound() throws Exception {
        // given
        var softSkillNameId = 1;
        var softSkillNameToModify = createWriteSoftSkillNameDto(1);
    ...
    void shouldDeleteSoftSkillName() throws Exception {
        ...
        // then
        result.andExpect(status().isOk())
                .andExpect(content().string(getDeletedEntityMessage(softSkillNameToDelete.getId())));
