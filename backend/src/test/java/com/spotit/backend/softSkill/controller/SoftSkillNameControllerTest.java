...
import static com.spotit.backend.testUtils.SoftSkillNameUtils.createReadSoftSkillNameDto;
import static com.spotit.backend.testUtils.SoftSkillNameUtils.createWriteSoftSkillNameDto;
import static com.spotit.backend.testUtils.SoftSkillNameUtils.generateSoftSkillNameList;
...
class SoftSkillNameControllerTest {
    ...
    void shouldReturnListOfSoftSkillNames() throws Exception {
        ...
        when(softSkillNameMapper.toReadDto(any()))
            .thenReturn(createReadSoftSkillNameDto(1));
    ...
    void shouldReturnCreatedSoftSkillName() throws Exception {
        // given
        var softSkillNameToCreate = createWriteSoftSkillNameDto(1);
        var createdSoftSkillName = createReadSoftSkillNameDto(1);
    ...
    void shouldReturnSoftSkillNameById() throws Exception {
        ...
        var softSkillName = createReadSoftSkillNameDto(softSkillNameId);
    ...
    void shouldReturnModifiedSoftSkillName() throws Exception {
        // given
        var softSkillNameId = 1;
        var softSkillNameToModify = createWriteSoftSkillNameDto(softSkillNameId);
        var modifiedSoftSkillName = createReadSoftSkillNameDto(softSkillNameId);
    ...
    void shouldDeleteSoftSkillName() throws Exception {
        ...
        result.andExpect(status().isOk())
                .andExpect(content().string(getDeletedEntityMessage(softSkillNameId)));
    }
